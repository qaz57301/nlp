...
class DiyBert:
    ...
    def load_weights(self, state_dict):
        ...
        # print(self.word_embeddings.shape, self.position_embeddings.shape, self.token_type_embeddings.shape,
        #       self.embeddings_layer_norm_weight.shape, self.embeddings_layer_norm_bias.shape)
        ...
        for i in range(self.num_layers):
            ...
            # print(i, q_w.shape, q_b.shape, k_w.shape, k_b.shape, v_w.shape,v_b.shape)
            ...
            # print("==========")
            # print(attention_output_weight.shape, attention_output_bias.shape,attention_layer_norm_w.shape,attention_layer_norm_b.shape,
            #       intermediate_weight.shape,intermediate_bias.shape,output_weight.shape,output_bias.shape,ff_layer_norm_w.shape,ff_layer_norm_b.shape)
            ...
            # print("transformer_weights", self.transformer_weights)
        #pooler层
    ...
    def single_transformer_layer_forward(self, x, layer_index):
        ...
        feed_forward_x = self.feed_forward(x,
                              intermediate_weight, intermediate_bias,
                              output_weight, output_bias)
        #bn层，并使用了残差机制 batch normalization
